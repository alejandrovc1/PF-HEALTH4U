...
//                     <h1 className={style.title}>We Always Provide Best Service</h1>
//                     <p className={style.text}>More than 50 specialist doctors waiting to assist you, makean appointment <br />that fits your schedule</p>
