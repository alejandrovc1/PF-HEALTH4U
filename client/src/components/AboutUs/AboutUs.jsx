            ...
            <div className={s.conten}>
                ...
                <div className={s.contenInfo}>
                    ...
                    <div className={s.contoenInfoMision}>
                        ...
                        <p className={s.infoMision}>HEALTH 4U is a digital platform where you wilL
                            <br />
                            be able to find everything you are looking for
                            <br />
                    ...
                    <div className={s.contoenInfoNosotros}>
                        ...
                        <p className={s.infoNosotros}>We are an ambitious company that seeks
                            ...
                            <br />
                            digital with the new technologies that we implement</p>
